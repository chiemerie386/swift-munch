...
// import mongoose from "mongoose"
var th = "mongodb+srv://Admin:Admin@task9.l8ypz.mongodb.net/test?retryWrites=true&w=majority";
var bb = process.env.MONGO_URI;
mongoose.connect("mongodb+srv://Admin:admin@liveproject.tynfk.mongodb.net/Food-App?retryWrites=true&w=majority", {
    useNewUrlParser: true,
    useUnifiedTopology: true,
    // useCreateIndex: true,
    // useFindAndModify: true,
}).then(function () { return console.log("connected to database lets see"); })
    .catch(function () { return console.log("not connected" + process.env.MONGO_URI); });
